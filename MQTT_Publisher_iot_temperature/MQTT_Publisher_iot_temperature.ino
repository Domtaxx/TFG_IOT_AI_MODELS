...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("ESP32Client_iot_temp", mqtt_username, mqtt_password)) {
...
void loop() {
  ...
  float num = random(15000001, 35000001) / 1000000.0;  // Generate random number between 0-1
  char message[10];
  ...
  delay(3500);  // Publish every 3 seconds
}
